...
#Bug ID 4949 - update mng. status to once and start and end year
mh_cleaned <- mh_cleaned %>%
...
#Bug ID 4546 - update End day and End time following guidance not to capture end time of 2400 hours
mh_cleaned <- mh_cleaned %>%
  mutate(END_DAY = case_when(REGULATION_ID == 4318 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4318 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4317 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4317 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4316 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4316 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4315 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4315 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4314 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4314 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4319 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4319 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4313 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4313 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4308 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4308 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4307 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4307 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4306 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4306 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4305 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4305 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4309 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4309 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4312 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4312 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4311 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4311 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4310 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4310 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4298 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4298 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4299 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4299 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4300 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4300 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4301 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4301 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4302 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4302 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4303 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4303 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4294 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4294 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4295 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4295 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4297 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4297 ~ '',
                              TRUE ~ END_TIME),
         END_DAY = case_when(REGULATION_ID == 4296 ~ 23L,
                             TRUE ~ END_DAY),
         END_TIME = case_when(REGULATION_ID == 4296 ~ '',
                              TRUE ~ END_TIME))
...
#Bug ID 5086 - Update effective and start date following correction guidance
mh_cleaned <- mh_cleaned %>%
...
mh_cleaned <- mh_cleaned %>%
  mutate(MANAGEMENT_CATEGORY = case_when(REGULATION_ID == 1085 ~ 'OTHER',
         ...
         MANAGEMENT_TYPE = case_when(REGULATION_ID == 1085 ~ 'IGNORABLE',
                                     TRUE ~ MANAGEMENT_TYPE),
         FR_CITATION = case_when(REGULATION_ID == 1085 ~ '56 FR 37606',
                                 TRUE ~ FR_CITATION),
         ...
         START_YEAR = case_when(REGULATION_ID == 1085 ~ 1991L,
                                TRUE ~ START_YEAR),
         START_MONTH = case_when(REGULATION_ID == 1085 ~ 8L,
                               TRUE ~ START_MONTH),
